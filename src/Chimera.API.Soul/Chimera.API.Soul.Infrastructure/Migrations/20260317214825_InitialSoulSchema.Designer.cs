...
namespace Chimera.API.Soul.Infrastructure.Migrations
{
    ...
    [Migration("20260317214825_InitialSoulSchema")]
    partial class InitialSoulSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Chimera.API.Soul.Domain.Entities.Plan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.PrimitiveCollection<string[]>("AllowedModelTiers")
                        .IsRequired()
                        .HasColumnType("text[]")
                        .HasColumnName("allowed_model_tiers");
                    ...
                    b.Property<int>("MaxAiCards")
                        .HasColumnType("integer")
                        .HasColumnName("max_ai_cards");

                    b.Property<int>("MaxMemories")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(500)
                        .HasColumnName("max_memories");

                    b.Property<int>("MaxMessagesDay")
                        .HasColumnType("integer")
                        .HasColumnName("max_messages_day");

                    b.Property<int>("MaxTokensDay")
                        .HasColumnType("integer")
                        .HasColumnName("max_tokens_day");
                    ...
                    b.Property<int>("PriceCentsMonth")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("price_cents_month");

                    b.Property<int?>("PriceCentsYear")
                        .HasColumnType("integer")
                        .HasColumnName("price_cents_year");
                    ...
                    b.ToTable("plans", "soul");
                });

            modelBuilder.Entity("Chimera.API.Soul.Domain.Entities.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CurrentPeriodEnd")
                        .HasDatabaseName("idx_subscriptions_expiry")
                    ...
                    b.HasIndex("UserId")
                        .IsUnique()
                        .HasDatabaseName("idx_subscriptions_user_active")
                        .HasFilter("status IN ('active', 'trialing')");

                    b.ToTable("subscriptions", "soul");
                });
            ...
            modelBuilder.Entity("Chimera.API.Soul.Domain.Entities.Subscription", b =>
                {
                    b.HasOne("Chimera.API.Soul.Domain.Entities.Plan", "Plan")
                        .WithMany()
