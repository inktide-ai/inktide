...
/// <summary>
/// Wraps the content stream from an ElevenLabs HTTP response and owns the
...
/// </summary>
internal sealed class ElevenLabsResponseStream : Stream
{
    private readonly Stream _inner;
    private readonly HttpResponseMessage _response;
    private bool _disposed;

    internal ElevenLabsResponseStream(Stream inner, HttpResponseMessage response)
    {
        _inner    = inner;
        _response = response;
    }
