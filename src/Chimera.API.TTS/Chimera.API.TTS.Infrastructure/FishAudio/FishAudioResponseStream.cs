...
/// <summary>
/// Wraps the content stream from a Fish Audio HTTP response and owns the
...
/// </summary>
internal sealed class FishAudioResponseStream : Stream
{
    private readonly Stream _inner;
    private readonly HttpResponseMessage _response;
    private bool _disposed;

    internal FishAudioResponseStream(Stream inner, HttpResponseMessage response)
    {
        _inner    = inner;
        _response = response;
    }
