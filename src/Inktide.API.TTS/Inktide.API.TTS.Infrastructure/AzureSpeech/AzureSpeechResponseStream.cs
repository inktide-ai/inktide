...
/// <summary>
/// Wraps the content stream from an Azure Speech HTTP response and owns the
...
/// </summary>
internal sealed class AzureSpeechResponseStream : Stream
{
    private readonly Stream _inner;
    private readonly HttpResponseMessage _response;
    private bool _disposed;

    internal AzureSpeechResponseStream(Stream inner, HttpResponseMessage response)
    {
        _inner    = inner;
        _response = response;
    }
