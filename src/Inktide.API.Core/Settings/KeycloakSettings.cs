...
public sealed class KeycloakSettings
{
    ...
    /// <summary>
    /// Keycloak realm issuer URL, e.g. <c>http://localhost:8080/realms/inktide</c>.
    ...
    /// e.g. in Docker: <c>http://keycloak:8080/realms/inktide/.well-known/openid-configuration</c>.
