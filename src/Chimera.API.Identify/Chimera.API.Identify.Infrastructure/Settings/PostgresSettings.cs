...
public sealed class PostgresSettings
{
    ...
    {
        get => _database;
        set => _database = string.IsNullOrWhiteSpace(value) ? "postgres" : value.Trim();
    }
    
    /// <summary>Username postgres. Prefer env POSTGRES_USER or PostgresSettings__Username.</summary>
