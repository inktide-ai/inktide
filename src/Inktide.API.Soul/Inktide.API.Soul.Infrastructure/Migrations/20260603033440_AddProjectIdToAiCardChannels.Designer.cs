...
namespace Inktide.API.Soul.Infrastructure.Migrations
{
    ...
    [Migration("20260603033440_AddProjectIdToAiCardChannels")]
    partial class AddProjectIdToAiCardChannels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Inktide.API.Soul.Domain.Entities.AiCardChannel", b =>
                {
                    ...
                    b.HasIndex("ProjectId", "Platform", "ChannelName")
                        .IsUnique()
                        .HasDatabaseName("IX_ai_card_channels_project_id_platform_channel_name")
