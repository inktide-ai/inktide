        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql($"""
                INSERT INTO soul.llm_catalog (id, provider, model_id, display_name, tier, is_available, created_at) VALUES
                  ...
                  ('11111111-0005-0000-0000-000000000001', 'google',     'gemini-2.0-flash',                       'Gemini 2.0 Flash',           'free', true, '{_now:O}'),
                  ('11111111-0005-0000-0000-000000000002', 'google',     'gemini-1.5-pro',                         'Gemini 1.5 Pro',             'pro',  true, '{_now:O}'),
