      ...
      {showToolbar ? (
        <div className="absolute top-[14px] right-[14px] flex flex-row items-center gap-1.5 z-10">
          ...
          {showChat && (
            <button
              type="button"
              className={cn(toolbarBtnBase, chatVisible && 'border-[rgba(99,102,241,0.5)] bg-[rgba(99,102,241,0.12)] text-indigo-300 hover:bg-[rgba(99,102,241,0.18)] hover:border-[rgba(99,102,241,0.6)] hover:text-indigo-300')}
