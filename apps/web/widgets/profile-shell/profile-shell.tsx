...
import { Home, Search } from '@/shared/ui/icons'
      ...
      <aside className="flex w-72 flex-shrink-0 flex-col bg-[var(--c-bacSec)] shadow-[inset_calc(var(--direction)*-1px)_0_0_0_var(--c-borSec)]">
          ...
          <div className="flex items-center justify-between px-3 py-2.5">
            ...
            >
              ...
              <div className="flex min-w-0 flex-1 flex-col items-start overflow-hidden">
                <span className="w-full truncate text-body font-semibold leading-snug text-[var(--text-primary)]">
                ...
                <div className="h-[12px] w-full overflow-hidden">
                  <div className="flex flex-col transition-transform duration-200 ease-out group-hover:-translate-y-[12px]">
                    <span className="block h-[12px] truncate text-left text-2xs leading-[12px] text-[var(--text-secondary)]">
                      Free Plan
                    </span>
                    <span className="block h-[12px] truncate text-left text-2xs leading-[12px] text-[var(--text-secondary)]">
                      {sidebarHandle}
          ...
          <div className="px-2 pb-1.5">
            {searchOpen ? (
              ...
              <div className="flex items-center justify-between px-2 py-1">
                <span className="font-[family-name:var(--font-ui)] text-sm font-medium text-[var(--text-tertiary)]">
                ...
                >
                  <span className="[&>svg]:w-[16px] [&>svg]:h-[16px]"><Search size={18} /></span>
                </button>
              </div>
            )}
          </div>
        ...
        <div className="px-2 py-3">
          <button
            ...
            className="flex h-9 w-full cursor-pointer items-center justify-center gap-1.5 rounded-lg border border-[var(--border-default)] bg-[var(--surface-2)] text-sm font-medium text-[var(--text-secondary)] outline-none transition-colors hover:border-[var(--border-strong)] hover:bg-[var(--surface-3)] hover:text-[var(--text-primary)] active:border-[var(--accent-primary)] active:bg-[var(--accent-soft)]"
          >
