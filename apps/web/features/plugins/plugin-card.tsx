        ...
        <div className="flex flex-row items-center gap-3 min-w-0">
          ...
          <div className="flex min-w-0 flex-col gap-1">
            <div className="flex flex-row items-center gap-2">
              <span className="text-body font-medium leading-5 text-[var(--text-primary)]">{name}</span>
              {isEnabled ? (
                ...
                <span className="rounded-full border border-[var(--border-subtle)] bg-[var(--surface-2)] px-2 py-0.5 text-caption font-medium text-[var(--text-tertiary)]">
                  Disabled
                </span>
              )}
            </div>
            <span className="truncate text-sm text-[var(--text-secondary)]">{description}</span>
          </div>
        </div>
