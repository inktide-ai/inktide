...
import { getProjectPlugins, upsertProjectPlugin, type ProjectPlugin } from '@/features/plugins/api/plugins'
                          ...
                          <div className="flex gap-2">
                            <div className="flex flex-1 items-center gap-2 rounded-lg border border-[var(--border-subtle)] bg-[var(--bg-0)] px-3">
                              ...
                              <input
                                ...
                                className="w-full bg-transparent py-2 text-sm text-[var(--text-primary)] outline-none placeholder:text-[var(--text-tertiary)]"
                              />
                            </div>
                            <button
                              type="button"
                              ...
                              className="h-9 rounded-lg bg-[var(--accent-primary)] px-3 text-sm font-medium text-white hover:bg-[var(--accent-hover)] disabled:opacity-50"
                            >
                              Save
                            </button>
                          </div>
                ...
                {BUILTIN_PLUGINS.map(def => (
                  <div key={def.id} className="flex flex-row items-start gap-3">
                    ...
                    <div className="flex flex-col">
                      ...
                      <p className="text-body leading-snug text-[var(--text-secondary)]">{def.description}</p>
                    </div>
                  </div>
                ))}
              </div>
