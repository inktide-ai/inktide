      ...
      <div className="overflow-hidden rounded-xl border border-[var(--border-card)]">
        ...
        <div className="flex items-center justify-between border-b border-[var(--border-subtle)] px-5 py-3.5">
          ...
          <button
            ...
            onClick={handleSave}
            className="flex h-8 items-center gap-1.5 rounded-lg bg-[var(--accent-primary)] px-4 text-body font-medium text-white hover:bg-[var(--accent-hover)] disabled:cursor-not-allowed disabled:opacity-40 transition-opacity"
          >
        ...
        <div className="bg-[var(--bg-0)] px-5 py-4">
          <p className="mb-3 text-body text-[var(--text-secondary)]">
          ...
          <textarea
            ...
            className="w-full resize-y rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)] px-4 py-3 font-mono text-body leading-relaxed text-[var(--text-primary)] outline-none placeholder:text-[var(--text-tertiary)] focus:border-[var(--accent-primary)] transition-colors"
          />
