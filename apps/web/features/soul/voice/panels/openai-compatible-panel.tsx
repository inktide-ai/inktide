  ...
  return (
    <>
      <section className="mb-6">
        ...
        <div className="overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)] divide-y divide-[var(--border-subtle)]">
          <div className="p-5">
            ...
            <p className="mb-3 text-xs text-[var(--text-tertiary)]">OpenAI-compatible API endpoint (e.g. http://localhost:1234/v1).</p>
          ...
          <div className="p-5">
            ...
            <p className="mb-3 text-xs text-[var(--text-tertiary)]">Optional — only if the endpoint requires auth.</p>
      ...
      <section className="mb-6">
        ...
        <div className="overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)] divide-y divide-[var(--border-subtle)]">
          <div className="p-5">
            <div className="mb-2 text-sm font-medium text-[var(--text-primary)]">Voice ID</div>
            <p className="mb-3 text-xs text-[var(--text-tertiary)]">Free-form voice identifier supported by your endpoint.</p>
            <input className={inputCls} type="text" placeholder="alloy" value={tts.voiceId ?? ''} onChange={(e) => patch({ voiceId: e.target.value || null })} />
          </div>
          <div className="p-5">
            <div className="mb-2 text-sm font-medium text-[var(--text-primary)]">Model ID</div>
            <p className="mb-3 text-xs text-[var(--text-tertiary)]">Free-form model identifier.</p>
