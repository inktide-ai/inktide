  ...
  return (
    <div>
      ...
      >
        ...
        />
        <span className="text-[14px] font-medium text-[var(--text-heading)]">Memory Snapshot</span>
        <span className="ml-auto mr-3 text-[14px] text-[var(--text-secondary)]">3 entries</span>
        <button
          type="button"
