...
import type { PipelineNodeType } from '../nodes/node-definitions'

// ── Icons ─────────────────────────────────────────────────────────────────────

export const IcArrowIn = () => (
...
export const NODE_ICONS: Record<PipelineNodeType, React.ReactNode> = {
  input:           <IcArrowIn />,
...
export function PasswordCell({ label, value, onChange, placeholder }: {
...
export function TextAreaCell({ label, value, onChange, placeholder, rows = 3 }: {
  label: string; value: string; onChange: (v: string) => void
...
export function InputCell({ label, value, onChange, min, max, step = 1, span }: {
...
export function InputGrid({ legend, children }: { legend: string; children: React.ReactNode }) {
  return (
