...
import { type Tool, type SaveStatus, STATUS_COLOR } from '../lib/graph-defaults'
...
export function AddNodePanel({ anchorRef, onAdd, onClose }: AddNodePanelProps) {
  useEffect(() => {
...
export function Toolbar({ active, locked, onTool, onAddClick, onDeleteSelected, saveStatus, lastSavedAt }: ToolbarProps) {
  const btn = (
    tool: Tool,
