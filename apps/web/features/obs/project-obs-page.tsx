      ...
      <div className="mb-4 overflow-hidden rounded-xl border border-[var(--border-subtle)]">
          ...
          <div className="flex w-[280px] shrink-0 items-center justify-center border-r border-[var(--border-subtle)] bg-[var(--surface-1)]/30 py-10">
            <div className="flex flex-col items-center gap-2 text-[var(--text-tertiary)]">
              ...
              <span className="text-body">
                {isReady ? t('page.browserSourceReady') : t('page.notConfiguredShort')}
              </span>
            </div>
          </div>
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <CheckItem
              ok={hasChannel}
              label={t('page.activeChannel')}
              sub={hasChannel
                ? t('page.activeChannelCount', { count: channels?.length ?? 0 })
                : t('page.channelWarn')}
            />
          </div>
        </AccordionSection>
            ...
            {[
              {
                ...
                desc: t('page.step1Desc'),
              },
              {
                n: 2,
                title: t('page.step2Title'),
                desc: t('page.step2Desc'),
              },
              {
                n: 3,
                title: t('page.step3Title'),
                desc: t('page.step3Desc'),
              ...
              <div key={n} className="flex items-start gap-3 rounded-xl px-3 py-3 transition-colors hover:bg-[var(--surface-1)]/50">
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[var(--border-subtle)] bg-[var(--surface-2)] text-xs font-semibold text-[var(--text-secondary)]">
                  {n}
                </span>
                <div className="pt-0.5">
                  ...
                  {code && (
                    <code className="mt-2 inline-block select-all rounded-lg border border-[var(--border-subtle)] bg-black/40 px-3 py-1.5 font-mono text-xs text-cyan-300/90">
                      {code}
                    </code>
                  )}
                </div>
