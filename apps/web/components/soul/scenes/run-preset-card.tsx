      ...
      <div className="flex items-start justify-between gap-2">
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <p className="home-heading-font truncate text-[14px] font-semibold text-[var(--text-heading)]">
              {preset.name}
            </p>
            {preset.description && (
              <p className="home-ui-font truncate text-[14px] text-[var(--text-tertiary)]">{preset.description}</p>
            )}
          </div>
        </div>
          ...
          {preset.is_active && (
            <AnimatePresence mode="wait">
              <motion.span
                ...
                className="inline-flex items-center gap-1 rounded-full bg-[var(--accent-base)] px-2 py-0.5 text-[12px] font-bold uppercase tracking-wide text-white"
              >
                ...
                <>
                  ...
                  >
                    <button
                      ...
                      className="w-full px-3 py-1.5 text-left text-[14px] text-[var(--text-primary)] hover:bg-[var(--surface-1)]"
                    >
                      Edit
                    </button>
                    <button
                      ...
                      className="w-full px-3 py-1.5 text-left text-[14px] text-red-400 hover:bg-[var(--surface-1)]"
                    >
                      Delete
                    </button>
                  </motion.div>
      ...
      <div className="flex items-center justify-end">
        {preset.is_active ? (
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-md border border-[var(--border-divider)] px-3 py-1.5 text-[14px] font-medium text-[var(--text-secondary)] transition-colors hover:border-[var(--border-card)] hover:text-[var(--text-primary)] disabled:opacity-50"
          >
            <ZapOff size={12} />
            Deactivate
          </button>
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-md bg-[var(--accent-base)] px-3 py-1.5 text-[14px] font-semibold text-white transition-opacity hover:opacity-90 disabled:opacity-50"
          >
            <Zap size={12} />
