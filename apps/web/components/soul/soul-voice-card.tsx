  ...
  return (
    <div className="p-4">
      <div className="mb-3 flex items-center justify-between">
        <p className="text-[14px] font-medium text-[var(--text-heading)]">Voice</p>
      ...
      <div className="space-y-2">
        <div className="rounded-md border border-[var(--border-subtle)] bg-[var(--surface-1)] px-2.5 py-2">
          <p className="text-[10px] text-[var(--text-tertiary)]">Voice Model</p>
          <p className="text-[14px] font-medium text-[var(--text-primary)]">{character.tts.voiceId ?? 'Garry Voice v2'}</p>
        </div>
