      ...
      <div className={styles.section}>
        ...
        <div className={styles.servicesGrid}>
          ...
          <div className={`${styles.serviceCard} ${styles.serviceCardBrain}`}>
            ...
            <img src="/images/illustrations/brain.png" className={styles.serviceIllustration} alt="" aria-hidden />
          ...
          <div className={`${styles.serviceCard} ${styles.serviceCardVoice}`}>
            ...
            <img src="/images/illustrations/voice.png" className={styles.serviceIllustration} alt="" aria-hidden />
            <div className={styles.serviceCardBottom}>
          ...
          <div className={`${styles.serviceCard} ${styles.serviceCardVision}`}>
            ...
            <img src="/images/illustrations/vision.webp" className={styles.serviceIllustration} alt="" aria-hidden />
            <div className={styles.serviceCardBottom}>
