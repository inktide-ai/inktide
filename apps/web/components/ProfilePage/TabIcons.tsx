...
export const IconMessage = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
    <path fillRule="evenodd" clipRule="evenodd" d="M22 10.787c0 4.854-4.253 8.788-9.5 8.788a10.22 10.22 0 0 1-2.684-.355c-1.881 1.241-4.233 1.617-5.485 1.73-.286.027-.434-.347-.24-.559.595-.65 1.431-1.803 1.715-3.368C4.073 15.43 3 13.225 3 10.787 3 5.934 7.253 2 12.5 2S22 5.934 22 10.787z" fill="currentColor" />
  </svg>
)
...
export const IconBrain = () => (
  <svg width="18" height="18" viewBox="0 0 512 512" fill="none" aria-hidden>
    <path
      fill="currentColor"
      d="M512,19.25c0-10.1-8.195-18.279-18.287-18.279H308.866v73.652c4.586-2.558,9.865-4.008,15.481-4.008
    ...
    <path
      fill="currentColor"
      d="M429.616,275.37h-92.794c-3.25,0-6.256,1.718-7.901,4.504l0.09-0.154l-0.106,0.171
...
export const IconPaint = () => (
  <svg width="18" height="18" viewBox="0 0 512 512" fill="none" aria-hidden>
    <path d="M148.05 63.012L90.58 5.543c-7.394-7.394-19.388-7.386-26.787 0L5.546 63.793c-7.394 7.402-7.394 19.385 0 26.787l57.47 57.462L148.05 63.012z" fill="currentColor" />
    <path d="M214.152 68.51c-15.05-12.564-37.193-11.561-51.06 2.295l-92.288 92.288c-13.859 13.856-14.856 36.005-2.294 51.056L317.133 512l194.866-194.871L214.152 68.51z M254.253 344.02l-81.886-81.89 89.758-89.763 81.886 81.89L254.253 344.02z" fill="currentColor" />
  </svg>
)
...
export const IconObs = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
    ...
    <circle cx="12" cy="12" r="6.5" stroke="currentColor" strokeWidth="2" fill="none" />
    <circle cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.35" />
  </svg>
)
...
export const IconIntegration = () => (
  <svg width="18" height="18" viewBox="0 0 512 512" fill="none" aria-hidden>
    <path
      fill="currentColor"
      d="M278.172,297.375l-51.203,51.188c0.016,0.594,0.031,1.188,0.031,1.781c0,8.406-1.594,16.781-4.766,24.625
    ...
    <path
      fill="currentColor"
      d="M502.625,79.844c-6.25-15.438-15.672-29.938-28.109-42.359c-12.422-12.422-26.922-21.859-42.359-28.109
    ...
    <path
      fill="currentColor"
      d="M160.219,351.781c12.234,12.25,32.063,12.25,44.281,0L351.781,204.5c12.219-12.219,12.25-32.031,0-44.281
