    ...
    <div className={styles.chat}>
      <div className={styles.body} ref={listRef}>
        {messages.length === 0 ? (
          <div className={styles.empty}>
            <img src="/logo/icon_without_white.svg" className={styles.emptyLogo} alt="" aria-hidden />
          ...
          messages.map((msg) => (
            ...
            >
              {msg.role === 'assistant' && (
                <img src="/logo/icon_without_white.svg" className={styles.msgAvatar} alt="" aria-hidden />
              )}
      ...
      <div className={styles.inputBar}>
        <button
          ...
          aria-label="Send"
        >
          <img src="/icons/caret-down.svg" className={styles.sendIcon} alt="" aria-hidden />
        </button>
        <input
