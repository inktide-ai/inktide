        ...
        <div className="flex items-center justify-between gap-4 px-[1.125rem] py-3 border-t border-white/[0.07] shrink-0">
          ...
          <div className="flex gap-2 shrink-0">
            ...
            <button
              type="button"
              className={cn(
                'px-[1.125rem] py-[0.45rem] rounded-[7px] border-none bg-[#ED3E3E] text-white text-[0.875rem] font-semibold cursor-pointer transition-[background] duration-150',
                'hover:enabled:bg-[#ff5252] disabled:opacity-60 disabled:cursor-not-allowed',
              )}
