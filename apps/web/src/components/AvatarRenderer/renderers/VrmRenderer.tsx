...
import type { MouthWeights } from '../../../ports/IVisemeProvider'
import type { EmotionState, VrmAnimationContext } from '../../../ports/IVrmController'
...
export default function VrmRenderer({
  ...
  useEffect(() => {
    ...
    const controllers = createVrmControllers()
