...
const SOCIAL_LINKS = [
  ...
  {
    label: 'YouTube',
    href: 'https://youtube.com/@chimera',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden>
      ...
      <div className={styles.top}>
        <div className={styles.brandColumn}>
          <a href="#" className={styles.brand}>
            <img src={logoSvg} alt="" className={styles.logo} aria-hidden />
            <span className={styles.brandName}>Chimera</span>
          </a>
