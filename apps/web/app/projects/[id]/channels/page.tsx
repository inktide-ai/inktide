...
function IconTelegram() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 240" aria-hidden width="36" height="36">
      <defs>
        <linearGradient id="tg-browse-grad" x1="120" y1="240" x2="120" y2="0" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#1d93d2"/>
          <stop offset="1" stopColor="#38b0e3"/>
        </linearGradient>
      </defs>
      <circle cx="120" cy="120" r="120" fill="url(#tg-browse-grad)"/>
...
const btnPrimary =
  'inline-flex h-10 items-center justify-center whitespace-nowrap rounded-md bg-[var(--text-primary)] px-4 text-[0.875rem] font-medium text-[var(--bg-0)] transition-opacity hover:opacity-90 focus-visible:outline-none'
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex flex-col items-center justify-start gap-6 flex-initial p-6 border border-[var(--border-subtle)] rounded-xl w-[305px] shrink-0">
              ...
              <div className="flex flex-col items-stretch justify-start gap-6">
                {BROWSE_PLATFORMS.map(({ id: platformId, name, description, icon: Icon }) => (
                  <a key={platformId} href="#" className="no-underline group outline-none">
                    <div className="flex flex-row items-stretch justify-start gap-3">
                      ...
                      <div className="flex flex-col items-stretch justify-start">
                        ...
                        <p className="text-[0.875rem] text-[var(--text-secondary)] leading-snug">
                          {description}
                        </p>
                      </div>
                    </div>
