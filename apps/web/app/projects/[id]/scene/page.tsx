    ...
    <div className="mx-auto max-w-[860px] px-6 py-8">
      ...
      <section className="mb-8">
        <div className="mb-3 flex items-center gap-2">
          ...
          <h2 className="text-[14px] font-semibold text-[var(--text-primary)]">3D Model</h2>
          {project.active_model_id && (
            <span className="rounded-full bg-emerald-500/10 px-2 py-0.5 text-[12px] text-emerald-400">Active</span>
          )}
        </div>

        {models.length === 0 ? (
          <div className="flex h-[120px] items-center justify-center rounded-2xl border border-dashed border-[var(--border-subtle)] text-[14px] text-[var(--text-tertiary)]">
      ...
      <section>
        <div className="mb-3 flex items-center gap-2">
          ...
          <h2 className="text-[14px] font-semibold text-[var(--text-primary)]">Background</h2>
