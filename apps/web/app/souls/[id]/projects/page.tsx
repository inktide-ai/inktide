...
import { listProjects, importProjectFile, type ProjectListItem } from '@/features/projects/api/projects'
import { buildSpark } from '@/lib/spark'
import { exportProject } from '@/features/soul/api/index'
      ...
      <div className="min-h-screen bg-[var(--bg-0)] px-6 py-5 font-[Inter,sans-serif]">
        ...
        <div className="mx-auto max-w-[1300px]">
          ...
          <section className="mb-4 grid grid-cols-4 gap-3">
            <StatCard label="Total Projects"  value={String(projects.length)} accentColor="#8B5CF6" spark={buildSpark(projects.map(p => p.updated_at))} />
