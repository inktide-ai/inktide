...
import { useCardModel } from '@/components/avatar/hooks/use-card-model'
        ...
        <div className="flex gap-0">
          <div className="flex w-[280px] shrink-0 items-center justify-center border-r border-[var(--border-subtle)] bg-[var(--surface-1)]/30 py-10">
            <div className="flex flex-col items-center gap-2 text-[var(--text-tertiary)]">
              ...
              <span className="text-[14px]">{isReady ? 'Browser Source Ready' : 'Not Configured'}</span>
            </div>
          </div>
        ...
        <div className="border-t border-[var(--border-subtle)]">
          ...
          <div className="border-t border-[var(--border-subtle)] bg-black/30 px-5 py-3">
            {obsUrl
              ...
              : <span className="text-[14px] text-[var(--text-tertiary)]">Configure a model and active channel to generate the URL</span>
            }
          </div>
        </div>
          ...
          <div className="flex flex-col gap-1">
            {[
              ...
              <div key={n} className="flex items-start gap-3 rounded-xl px-3 py-3 transition-colors hover:bg-[var(--surface-1)]/50">
                <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full border border-[var(--border-subtle)] bg-[var(--surface-2)] text-[12px] font-semibold text-[var(--text-secondary)]">{n}</span>
                <div className="pt-0.5">
                  ...
                  {code && <code className="mt-2 inline-block select-all rounded-lg border border-[var(--border-subtle)] bg-black/40 px-3 py-1.5 font-mono text-[12px] text-cyan-300/90">{code}</code>}
                </div>
              </div>
            ))}
          </div>
