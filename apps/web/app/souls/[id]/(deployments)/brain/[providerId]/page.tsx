...
function OllamaConnectionPanel() {
  ...
  return (
    <div className="grid grid-cols-2 divide-x divide-[var(--border-subtle)]">
      <div className="p-5">
        <div className="mb-2 flex items-center gap-2 text-[14px] font-medium text-[var(--text-primary)]">
          <ComputerIcon />
          Server URL
        </div>
        <p className="mb-3 text-[14px] text-[var(--text-tertiary)]">URL of your local Ollama instance.</p>
        <input
          className={inputCls}
          type="text"
      ...
      <div className="p-5">
        ...
        <p className="mb-3 text-[14px] text-[var(--text-tertiary)]">
  ...
  return (
    <div className="grid grid-cols-2 divide-x divide-[var(--border-subtle)]">
      <div className="p-5">
        ...
        <p className="text-[14px] text-[var(--text-secondary)]">{def.fixedBaseUrl ?? 'Custom endpoint'}</p>
      </div>
      <div className="p-5">
        ...
        <p className="mb-3 text-[14px] text-[var(--text-tertiary)]">Enter your {def.name} API key to connect.</p>
        <div className="flex gap-2">
          ...
          <button
            ...
            className="h-9 shrink-0 rounded-lg bg-[var(--accent-primary)] px-4 text-[14px] font-semibold text-[var(--text-on-accent)] transition-colors hover:bg-[var(--accent-hover)] disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {saving ? 'Saving…' : 'Save'}
          </button>
        </div>
...
export default function SoulBrainProviderPage() {
  const { selected, selectedId, updateCharacter } = useCharactersContext()
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="overflow-hidden rounded-xl border border-[var(--border-subtle)] bg-[var(--surface-1)]">
              <div className="px-6 pt-5 pb-4">
                ...
                <p className="mt-1 text-[14px] text-[var(--text-secondary)]">These parameters apply to all providers.</p>
              </div>
            ...
            <div className="border-t border-[var(--border-subtle)] divide-y divide-[var(--border-subtle)]">
              {catalog ? [
                ...
                <div className="px-6 py-3">
                  <p className="text-[14px] text-[var(--text-tertiary)]">No additional information available.</p>
                </div>
              )}
            </div>
          </div>
