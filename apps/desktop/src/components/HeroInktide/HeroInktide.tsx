...
import {
  ...
  IconIntegration, IconScene, IconMemory, IconBackup, IconSearch,
...
// MOCK_TABS is built inside HeroInktide via useMemo to support i18n
        ...
        <div className={styles.rightColumn}>
          <div className={styles.appMockup}>
            ...
            <div className={styles.mockupChrome}>
              ...
              <span className={styles.mockupChromeTitle}>Inktide</span>
            </div>
                ...
                <aside className={styles.mSidebar}>
                  <div className={styles.mSidebarHeader}>
                    <div className={styles.mLogoRow}>
                      ...
                      <span className={styles.mLogoText}>Inktide</span>
                    </div>
                  </div>
