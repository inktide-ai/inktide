          ...
          <div className={styles.rightColumn}>
            <div className={styles.stackedCards}>
              <div className={styles.cardBack}>
                <span className={styles.cardLabel}>DO & DISCARD</span>
                <p className={styles.cardTextMuted}>
                  Best practices for AI stream integration...
                </p>
              </div>
              <div className={styles.cardMiddle}>
                <span className={styles.cardLabel}>WHAT WE MEASURE</span>
                <p className={styles.cardTextMuted}>
                  View artificial viewers, system metrics, human factor analysis...
                </p>
              </div>
              <div className={styles.cardFront}>
                <span className={styles.cardLabel}>THE IMPACT</span>
                ...
                <p className={styles.cardHighlight}>
                  Streamers using AI companions see up to 40% higher viewer retention and
                  increased chat activity. Our analytics help you understand what works.
                </p>
                <div className={styles.cardChart}>
                  <span className={styles.chartTitle}>AI Engagement by Platform</span>
